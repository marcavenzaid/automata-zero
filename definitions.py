...
def update_movement_vid_folder_path(self, new_path):
    # I have not used this method yet, but later add functionality to update json file.
    utilities.update_json_file(self._config_path, "movement_vid_folder_path", new_path)
...
MOVEMENT_VID_FOLDER_PATH = definitions_json["MOVEMENT_VID_FOLDER_PATH"]
